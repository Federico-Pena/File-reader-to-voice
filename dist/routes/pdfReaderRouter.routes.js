...
const getMimeTypes_1 = __importDefault(require("../controllers/getMimeTypes"));
const multer_1 = require("../middlewares/multer");
const pdfReaderRouter = (0, express_1.Router)();
const { uploadFile, getMimeTypes: getMimeTypesRoute } = apiConfig_1.apiConfig.API_ROUTES.uploadFile;
pdfReaderRouter.get(getMimeTypesRoute, getMimeTypes_1.default);
